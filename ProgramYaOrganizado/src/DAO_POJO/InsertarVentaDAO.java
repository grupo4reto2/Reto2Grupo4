...
public class InsertarVentaDAO {
    ...
    public int insertarVenta(Cliente cliente, List<Entrada> entradas) {
        ...
        con = conexion.getConnection();
            ...
            try {
            			sentencia = con.prepareStatement(sqlCheckCliente);
            ...
            try {
            	psCompra = con.prepareStatement(sqlInsertCompra, PreparedStatement.RETURN_GENERATED_KEYS);
            ...
            try { 
            	psEntrada = con.prepareStatement(sqlInsertEntrada);
            ...
            try { 
            	psUpdate = con.prepareStatement(sqlUpdateCompra);
